...
async function lottery(_0x441099) {
  ...
  const _0x3f3df5 = _0x518b43["split"]('_')[0];
  const _0x1b7023 = md5(_0x3f3df5 + '&' + _0x5cf979 + '&' + _0x589efa + '&' + JSON["stringify"](_0x4c8be9));
  const _0x4156e1 = {
...
async function lyb_sign(_0x3a3148) {
  ...
  const _0x2e8100 = _0x5c1418["split"]('_')[0];
  const _0x57f632 = md5(_0x2e8100 + '&' + _0x4458f1 + '&' + _0x47de7c + '&' + JSON["stringify"](_0x51fe1b));
  const _0x103a27 = {
    "url": "https://mtop.ele.me/h5/mtop.koubei.interactioncenter.sign.component.recordsignin/1.0/5.0/?jsv=2.7.1&appKey=12574478&t=" + _0x4458f1 + "&sign=" + _0x57f632 + "&api=mtop.koubei.interactioncenter.sign.component.recordsignin&v=1.0&ecode=1&type=json&valueType=string&needLogin=true&LoginRequest=true&dataType=jsonp&SV=5.0&asac=2A21607NIIT1ND5C4YXJ6C&secttid=h5%40android_chrome_87.0.4280.141",
    "method": "POST",
    "headers": _0x3a79b2,
    "body": _0x460cf7
  };
...
async function gameRequest(_0xc99132, _0x202860) {
  ...
  const _0x2db1ef = _0xfd701b["split"]('_')[0];
  const _0x12d1c9 = md5(_0x2db1ef + '&' + _0x100890 + '&' + _0x9f9faa + '&' + JSON["stringify"](_0x202860));
  const _0x1390dd = {
